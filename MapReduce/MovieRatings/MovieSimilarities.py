...
# Runt his code with following command from shell to capture execution time.
# date > sims.txt; python MovieSimilarities.py --items=ml-100k/u.item ml-100k/u.data >> sims.txt; date >> sims.txt