...
def main():
    ...
    if options.test: # Usage : python p2w.py -t OR python p2w.py -t < p2w.tst > p2y.txt
        test()
    else:
        if len(args) < 1:
...
'''
# Uncomment above else part and it will start printing the message each time the n2w module is imported.